...
This generates the [product-manager.agent.md](https://github.com/j0hnnymiller/zeus.academia.3b/blob/Part-Six/.github/agents/product-manager.agent.md) custom agent.
