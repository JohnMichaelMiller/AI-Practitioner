...
To build a reusable prompt for agent-governance instructions, I submitted this prompt: **{JOHN, WERE THESE THREE FILES CREATED EARIER IN THE SERIES? WHERE CAN THE READER FIND THEM?} {ERIK, THESE ARE LINKS TO THE GITHUB DOCS}**
...
[create-custom-agents-instructions.prompt.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/prompts/create-custom-agents-instructions.prompt.md)
...
Submitting the prompt with these arguments generates the actual instruction file that defines repository standards for authoring `.agent.md` profiles. The prior step created the generator; this step produces the generated artifact [custom-agents.instructions.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/instructions/custom-agents.instructions.md).
...
This generates the [product-manager.agent.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/agents/product-manager.agent.md) custom agent.
...
This prompt generates the [create-prd.prompt.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/prompts/create-prd.prompt.md) file:
...
[create-vertical-slice-implementation-instructions.prompt.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/prompts/create-vertical-slice-implementation-instructions.prompt.md)
...
[vertical-slice-implementation.instructions.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/instructions/vertical-slice-implementation.instructions.md)
...
[academia-workflows.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/models/workflows/academia-workflows.md)
...
[academia-implementation-plan.md](https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/models/workflows/academia-implementation-plan.md)
...
- Expand this post with a description of this prompt: "Prompt: submit this prompt #file:create-custom-agents-instructions.prompt.md with these arguments:
  ...
  agent_scope: repository
  include_ide_notes: true" and the file "https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/instructions/custom-agents.instructions.md" created by the prompt
...
- Add a section to this post with a description of this prompt: "submit the #file:create-product-manager-agent.prompt.md prompt file with these arguments:
  ...
  target: omit
  include_execute_tool: false
  scope_note: The universe of discourse is Academia Management" and the file "https://github.com/johnmillerATcodemag-com/zeus.academia.3b/blob/Part-Six/.github/agents/product-manager.agent.md" created by the prompt
