...
When generating GitHub AI guidance I used the custom [prompt-engineer.chatmode.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/a0ce78c1e527432044f574dafe4cca7cdacdd099/.github/chatmodes/prompt-engineer.chatmode.md) chat mode, introduced in [Part 2](https://www.codemag.com/blog/AIPractitioner/AIAGSD2/), which focuses Copilot on the skills needed to generate effective prompts.
...
[JOHN, THE LIST BELOW DOESN'T "FLOW" FOR ME FROM REVIEWING THE FILE ABOVE AND THEN AFTER THE LIST BELOW, THINGS JUST END ABRUPTLY. HOW DO THESE 8 STEPS HAPPEN? AND THINGS SEEM CUT OFF WITH "COPILOT DIDN'T FIND ANY ISSUES TO ADDRESS..." DID SOME PROCESS RUN WHERE YOU ASKED COPILOT TO ANALYZES SOMETHING?]
