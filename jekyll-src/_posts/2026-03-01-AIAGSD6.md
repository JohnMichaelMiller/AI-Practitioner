...
image: /assets/images/2026-03-01/AIAGSD6_Header_Large.png
---
...
<img src="/assets/images/2026-03-01/AIAGSD6_Header_Large.png" alt="Vertical slices flowing into implementation: showing the transition from planning artifacts (custom agents, PRDs, workflows) into coordinated slice-by-slice delivery">
...
The generates the [product-manager.agent.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/Part-Six/.github/agents/product-manager.agent.md) custom agent.
