...
These technology-specific instruction files solve this by providing:
...
## [Project Overview Instructions](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/project-overview.instructions.md)
...
### [aspnetcore-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/aspnetcore-implementation.instructions.md)
...
### [csharp-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/csharp-implementation.instructions.md)
...
### [fluentvalidation-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/fluentvalidation-implementation.instructions.md)
...
### [mediatr-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/mediatr-implementation.instructions.md)
...
### [pinia-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/pinia-implementation.instructions.md)
...
### [typescript-frontend-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/typescript-frontend-implementation.instructions.md)
...
### [vitest-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/vitest-implementation.instructions.md)
...
### [vue3-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/vue3-implementation.instructions.md)
...
### [xunit-implementation.instructions.md](https://github.com/JohnMichaelMiller/zeus.academia.3b/blob/main/.github/instructions/xunit-implementation.instructions.md)
...
Before moving on, it's a good idea to review the .github governance (prompts, instructions, etc.) to ensure there aren't conflicting governance rules that could confuse Copilot. Conflicts could arise from overlapping instructions, contradictory guidelines, or inconsistent priorities, defined in the instruction files. In [Part 2](https://blog.pdata.com/AIAGSD2/) I introduced the `check-context.prompt.md` file that examines the current context and reports any anomalies that should be addressed.
