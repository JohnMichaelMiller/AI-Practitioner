...
<a href="https://github.com/j0hnnymiller/zeus.academia.3b/blob/Part-Three/.github/instructions/ai-dev-process.instructions.md" target="_blank">`ai-dev-process.instructions.md`</a> file.
...
Here is a link to the <a href="https://github.com/j0hnnymiller/zeus.academia.3b/blob/Part-Three/.github/instructions/git-workflow.instructions.md" target="_blank">`git-workflow.instructions.md`</a> file.
...
Here is a link to the <a href="https://github.com/j0hnnymiller/zeus.academia.3b/blob/Part-Three/.github/instructions/project-overview.instructions.md" target="_blank">`project-overview.instructions.md`</a> file.
...
Here are links to the prompt files that created the instruction files: <a href="https://github.com/j0hnnymiller/zeus.academia.3b/blob/Part-Three/.github/prompts/create-ai-dev-process.prompt.md" target="_blank">`create-ai-dev-process.prompt.md`</a>, <a href="https://github.com/j0hnnymiller/zeus.academia.3b/blob/Part-Three/.github/prompts/create-git-workflow-instructions.prompt.md" target="_blank">`create-git-workflow-instructions.prompt.md`</a>, and <a href="https://github.com/j0hnnymiller/zeus.academia.3b/blob/Part-Three/.github/prompts/create-project-overview.prompt.md" target="_blank">`create-project-overview.prompt.md`</a>
...
If you're interested in seeing the files, you can find them in the <a href="https://github.com/j0hnnymiller/zeus.academia.3b" target="_blank">Academia GitHub repository</a>. If you like to follow along with your own implementation, fork this repo and use the fork to build you own implementation.
